...
const MAXIMUM_BATCH_RECORDS_LENGTH = 20;
...
class MetalitixLoggerBase {
    constructor(appKey, options = {}) {
        ...
        this.getRecord = (eventType, sessionId, { userEvent, camera }) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            ...
            if (this.currentFPS > 0) {
                base.metrics = (_a = base.metrics) !== null && _a !== void 0 ? _a : {};
        ...
        this.addRecord = (eventType, { userEvent, camera }) => __awaiter(this, void 0, void 0, function* () {
            if (this.sessionId === null) {
                return;
            }
            const record = yield this.getRecord(eventType, this.sessionId, { userEvent, camera });
        ...
        this.getUserMeta = () => {
            return Object.assign({}, this.userMeta, {
                ...
                systemInfo: _utils__WEBPACK_IMPORTED_MODULE_3__.systemInfo,
            });
        };
        this.addSessionStart = () => __awaiter(this, void 0, void 0, function* () {
            const camera = yield this.getCameraData(this.cameraOrScene);
            this.previousCameraData = camera || null;
            yield this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.SessionStart, { camera });
        });
        this.addSessionEnd = () => __awaiter(this, void 0, void 0, function* () {
            let camera = yield this.getCameraData(this.cameraOrScene);
            ...
            yield this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.SessionEnd, { camera });
        });
        this.addUserPosition = () => __awaiter(this, void 0, void 0, function* () {
            yield this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.UserPosition, {});
        });
        ...
        this.startSession = (cameraOrScene, object3D = null) => __awaiter(this, void 0, void 0, function* () {
        ...
        this.sendUserEvent = (eventName, eventType, target, points, params) => __awaiter(this, void 0, void 0, function* () {
            const userEvent = {
                object: 'user.event',
                eventName,
                eventType,
            ...
            yield this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.UserInteraction, { userEvent });
        });
        this.logCustomEvent = (eventName, params) => {
            this.sendUserEvent(eventName, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.Custom, undefined, undefined, params);
        };
        this.logKeyDownEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.KeyDown, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyDown, {
        ...
        this.logKeyPressEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.KeyPress, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyPress, {
        ...
        this.logKeyUpEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.KeyUp, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyUp, {
        ...
        this.logMouseEnterEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseEnter, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseEnter, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseLeaveEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseLeave, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseLeave, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseOverEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseOver, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseOver, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseOutEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseOut, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseOut, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseDownEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseDown, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseDown, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseUpEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseUp, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseUp, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logMouseMoveEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MouseMove, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseMove, {
        ...
        this.logMousePressEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.MousePress, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MousePress, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logTouchTapEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.TouchTap, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchTap, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logTouchStartEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.TouchStart, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchStart, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logTouchMoveEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.TouchMove, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchMove, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Updated,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logTouchEndEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.TouchEnd, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchEnd, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logZoomStartEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.ZoomStart, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomStart, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logZoomUpdateEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.ZoomUpdate, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomUpdate, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Updated,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
        ...
        this.logZoomEndEvent = (x, y, params) => {
            this.sendUserEvent(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionNames.ZoomEnd, _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomEnd, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            }, undefined, params);
...
(function (XRAnalytics) {
    ...
    (function (UserInteractionTypes) {
        ...
        UserInteractionTypes["Custom"] = "user.interaction.custom";
    ...
    let UserInteractionNames;
    (function (UserInteractionNames) {
        UserInteractionNames["KeyDown"] = "Key Down";
        UserInteractionNames["KeyPress"] = "Key Press";
        UserInteractionNames["KeyUp"] = "Key Up";
        UserInteractionNames["MouseEnter"] = "Mouse Enter";
        UserInteractionNames["MouseLeave"] = "Mouse Leave";
        UserInteractionNames["MouseOver"] = "Mouse Over";
        UserInteractionNames["MouseOut"] = "Mouse Out";
        UserInteractionNames["MouseDown"] = "Mouse Down";
        UserInteractionNames["MouseUp"] = "Mouse Up";
        UserInteractionNames["MouseMove"] = "Mouse Move";
        UserInteractionNames["MousePress"] = "Mouse Press";
        UserInteractionNames["TouchTap"] = "Touch Tap";
        UserInteractionNames["TouchStart"] = "Touch Start";
        UserInteractionNames["TouchMove"] = "Touch Move";
        UserInteractionNames["TouchEnd"] = "Touch End";
        UserInteractionNames["ZoomStart"] = "Zoom Start";
        UserInteractionNames["ZoomUpdate"] = "Zoom Update";
        UserInteractionNames["ZoomEnd"] = "Zoom End";
    })(UserInteractionNames = XRAnalytics.UserInteractionNames || (XRAnalytics.UserInteractionNames = {}));
    XRAnalytics.KnownUserInteractionNames = Object.values(UserInteractionNames);
    let EventTypes;
    (function (EventTypes) {
...
/* harmony import */ var device_detector_js_dist_parsers_device_mobiles__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! device-detector-js/dist/parsers/device/mobiles */ "./node_modules/device-detector-js/dist/parsers/device/mobiles.js");
/* harmony import */ var device_detector_js_dist_parsers_device_mobiles__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(device_detector_js_dist_parsers_device_mobiles__WEBPACK_IMPORTED_MODULE_1__);
var _a, _b;
...
const mobileParser = new (device_detector_js_dist_parsers_device_mobiles__WEBPACK_IMPORTED_MODULE_1___default())();
const device = mobileParser.parse(window.navigator.userAgent);
const systemInfo = {
    deviceModel: (platform__WEBPACK_IMPORTED_MODULE_0___default().product),
...
/* harmony export */ });
/* harmony import */ var _constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../constants */ "./src/constants/index.ts");
/* harmony import */ var _mtx_poll_base__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./mtx-poll-base */ "./src/lib/mtx-poll-base.ts");
...
/* harmony import */ var three_src_math_Euler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! three/src/math/Euler */ "./node_modules/three/src/math/Euler.js");
/* harmony import */ var three_src_math_Quaternion__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! three/src/math/Quaternion */ "./node_modules/three/src/math/Quaternion.js");
    ...
    constructor(appKey, options = {}) {
        ...
        this.getCamera = (scene) => {
            return new Promise(resolve => {
                ...
                scene === null || scene === void 0 ? void 0 : scene.addEventListener('loaded', () => {
                    setTimeout(() => {
                        var _a;
                        resolve((_a = scene === null || scene === void 0 ? void 0 : scene.closestScene().camera) !== null && _a !== void 0 ? _a : null);
                    }, this.loadingOrder);
                });
                this.loadingOrder = 50;
            });
        };
        this.getPositionData = (scene, object3D) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const camera = yield this.getCamera(scene);
            if (camera === null) {
                return undefined;
            }
            ...
            const resultObject3D = (_a = object3D !== null && object3D !== void 0 ? object3D : scene === null || scene === void 0 ? void 0 : scene.closestScene().object3D) !== null && _a !== void 0 ? _a : null;
            if (resultObject3D !== null) {
                const vector3 = new three_src_math_Vector3__WEBPACK_IMPORTED_MODULE_2__.Vector3();
                const euler = new three_src_math_Euler__WEBPACK_IMPORTED_MODULE_3__.Euler();
                const quaternion = new three_src_math_Quaternion__WEBPACK_IMPORTED_MODULE_4__.Quaternion();
        ...
        this.getCameraData = (scene) => __awaiter(this, void 0, void 0, function* () {
            const camera = yield this.getCamera(scene);
            if (camera === null) {
                return undefined;
            }
        ...
        this.getAnimationsData = () => {
            return Object.values(this.animationActions).map(action => {
                ...
                return {
                    ...
                    loop: action.loop === three_src_constants__WEBPACK_IMPORTED_MODULE_5__.LoopRepeat,
                };
            });
        };
        ...
        this.vector3 = new three_src_math_Vector3__WEBPACK_IMPORTED_MODULE_2__.Vector3();
        this.euler = new three_src_math_Euler__WEBPACK_IMPORTED_MODULE_3__.Euler();
        this.quaternion = new three_src_math_Quaternion__WEBPACK_IMPORTED_MODULE_4__.Quaternion();
        this.loadingOrder = 0;
    }
}
const MetalitixLoggerAFRAME = {
    schema: {
        interval: { default: _constants__WEBPACK_IMPORTED_MODULE_0__.DEFAULT_INTERVAL_VALUE },
    ...
    init() {
        ...
        this.logger.startSession(this.el);
    },
    pause() {
        var _a;
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.pauseSession();
    },
    play() {
        var _a;
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.resumeSession();
    },
    remove() {
        var _a;
        (_a = this.logger) === null || _a === void 0 ? void 0 : _a.endSession();
    },
};
...
//# sourceMappingURL=mtx-poll-a-frame.js.map