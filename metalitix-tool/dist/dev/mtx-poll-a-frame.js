...
/* harmony import */ var _mtx_poll_event__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./mtx-poll-event */ "./src/lib/mtx-poll-event.ts");
var __awaiter = (undefined && undefined.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
...
class MetalitixLoggerBase {
    constructor(appKey, options = {}) {
        ...
        this.addSessionEnd = () => {
            ...
            this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.SessionEnd, { data, userMeta, camera });
        };
        this.addUserPosition = () => {
            ...
            this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.UserPosition, { data, userMeta });
        };
        ...
        this.sendUserEvent = (eventName, eventType, target, points) => {
            const data = this.getPositionData(this.object3D);
            const userEvent = new _mtx_poll_event__WEBPACK_IMPORTED_MODULE_5__["default"](eventName, eventType, target, points);
            const userMeta = this.getUserMeta();
            if (data === undefined) {
                throw new Error('Data is required field!');
            }
            this.addRecord(_types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.EventTypes.UserInteraction, { data, userMeta, userEvent: userEvent.toJSON() });
            return userEvent;
        };
        this.logCustomEvent = (eventName) => {
            return this.sendUserEvent(eventName, 'custom');
        };
        this.logKeyDownEvent = (x, y) => {
            return this.sendUserEvent('key_down', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyDown, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logKeyPressEvent = (x, y) => {
            return this.sendUserEvent('key_press', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyPress, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logKeyUpEvent = (x, y) => {
            return this.sendUserEvent('key_up', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.KeyUp, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseEnterEvent = (x, y) => {
            return this.sendUserEvent('mouse_enter', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseEnter, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseLeaveEvent = (x, y) => {
            return this.sendUserEvent('mouse_leave', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseLeave, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseOverEvent = (x, y) => {
            return this.sendUserEvent('mouse_over', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseOver, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseOutEvent = (x, y) => {
            return this.sendUserEvent('mouse_out', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseOut, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseDownEvent = (x, y) => {
            return this.sendUserEvent('mouse_down', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseDown, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseUpEvent = (x, y) => {
            return this.sendUserEvent('mouse_up', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseUp, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMouseMoveEvent = (x, y) => {
            return this.sendUserEvent('mouse_move', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MouseMove, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Updated,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logMousePressEvent = (x, y) => {
            return this.sendUserEvent('mouse_press', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.MousePress, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logTouchTapEvent = (x, y) => {
            return this.sendUserEvent('touch_tap', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchTap, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Stationary,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logTouchStartEvent = (x, y) => {
            return this.sendUserEvent('touch_start', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchStart, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logTouchMoveEvent = (x, y) => {
            return this.sendUserEvent('touch_move', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchMove, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Updated,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logTouchEndEvent = (x, y) => {
            return this.sendUserEvent('touch_end', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.TouchEnd, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logZoomStartEvent = (x, y) => {
            return this.sendUserEvent('zoom_start', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomStart, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Pressed,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logZoomUpdateEvent = (x, y) => {
            return this.sendUserEvent('zoom_update', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomUpdate, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Updated,
                timestamp: Date.now(),
                position: { x, y },
            });
        };
        this.logZoomEndEvent = (x, y) => {
            return this.sendUserEvent('zoom_end', _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.UserInteractionTypes.ZoomEnd, {
                state: _types__WEBPACK_IMPORTED_MODULE_2__.XRAnalytics.PointStates.Released,
                timestamp: Date.now(),
                position: { x, y },
            });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ MetalitixLoggerEvent)
/* harmony export */ });
class MetalitixLoggerEvent {
    constructor(eventName, eventType, target, points) {
        this.object = 'user.event';
        this.params = {};
        this.setCustomEventData = (paramKey, paramValue) => {
...
/* harmony import */ var three_src_math_Euler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! three/src/math/Euler */ "./node_modules/three/src/math/Euler.js");
...
class MetalitixLogger extends _mtx_poll_base__WEBPACK_IMPORTED_MODULE_1__["default"] {
    constructor(appKey, options = {}) {
        ...
        this.getAnimationsData = () => {
            return Object.values(this.animationActions)
                ...
                return {
                    ...
                    loop: action.loop === three_src_constants__WEBPACK_IMPORTED_MODULE_2__.LoopRepeat,
                };
            });
        };
        ...
        this.vector3 = new three_src_math_Vector3__WEBPACK_IMPORTED_MODULE_3__.Vector3();
        this.euler = new three_src_math_Euler__WEBPACK_IMPORTED_MODULE_4__.Euler();
        this.quaternion = new three_src_math_Quaternion__WEBPACK_IMPORTED_MODULE_5__.Quaternion();
    }
}
