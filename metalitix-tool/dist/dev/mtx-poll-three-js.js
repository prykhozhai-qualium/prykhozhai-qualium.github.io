...
class MetalitixLogger extends _mtx_poll_base__WEBPACK_IMPORTED_MODULE_0__["default"] {
    constructor(appKey, options = {}) {
        ...
        this.getPositionData = (camera, object3D) => __awaiter(this, void 0, void 0, function* () {
            if (camera === null) {
                return undefined;
            }
            ...
            if (object3D !== undefined && object3D !== null) {
                const vector3 = new three_src_math_Vector3__WEBPACK_IMPORTED_MODULE_1__.Vector3();
                const euler = new three_src_math_Euler__WEBPACK_IMPORTED_MODULE_2__.Euler();
                const quaternion = new three_src_math_Quaternion__WEBPACK_IMPORTED_MODULE_3__.Quaternion();
        ...
        this.getCameraData = (camera) => __awaiter(this, void 0, void 0, function* () {
            if (camera === null) {
                return undefined;
            }
            return {
        ...
        this.getAnimationsData = () => {
            return Object.values(this.animationActions).map(action => {
                ...
                return {
                    ...
                    loop: action.loop === three_src_constants__WEBPACK_IMPORTED_MODULE_4__.LoopRepeat,
                };
            });
        };
